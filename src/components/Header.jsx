...
export default function Header() {
  const [user, setUser] = useState({
    name: '',
    email: '',
    imageUrl: `https://ui-avatars.com/api/?background=c36914&color=fff&name=-`,
  });
  ...
  const setDataUser = (us) => {
    setUser({
      name: us?.username,
      email: us?.email,
      imageUrl: `https://ui-avatars.com/api/?background=c36914&color=fff&name=${us?.username}`,
    });
  };
                    ...
                    <Menu as="div" className="ml-3 relative">
                      ...
                      >
                        <Menu.Items className="origin-top-right absolute right-0 mt-2 w-48 rounded-md shadow-lg py-1 bg-white ring-1 ring-black ring-opacity-5 focus:outline-none">
                          <Menu.Item disabled>
                            <span className={'block px-4 py-2 text-center text-sm text-gray-700'}>{user.name}</span>
                          </Menu.Item>
